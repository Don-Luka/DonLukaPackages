...
class D2_frame_element:
    def __init__(self, node_i, node_k, E, nu, rho, k, b, h):
        ...
        self.Phi = 12*self.E*self.J/(self.k*self.G*self.A*self.l**2)
...
def K_lin_loc(self):
    k = np.array([
        ...
        [0, 12*self.E*self.J/(self.l**3*(self.Phi + 1)), 6*self.E*self.J/(self.l**2*(self.Phi + 1)), 0, -12*self.E*self.J/(self.l**3*(self.Phi + 1)), 6*self.E*self.J/(self.l**2*(self.Phi + 1))],
        [0, 6*self.E*self.J/(self.l**2*(self.Phi + 1)), self.E*self.J*(self.Phi + 4)/(self.l*(self.Phi + 1)), 0, -6*self.E*self.J/(self.l**2*(self.Phi + 1)), self.E*self.J*(2 - self.Phi)/(self.l*(self.Phi + 1))], 
        [-self.A*self.E/self.l, 0, 0, self.A*self.E/self.l, 0, 0], 
        [0, -12*self.E*self.J/(self.l**3*(self.Phi + 1)), -6*self.E*self.J/(self.l**2*(self.Phi + 1)), 0, 12*self.E*self.J/(self.l**3*(self.Phi + 1)), -6*self.E*self.J/(self.l**2*(self.Phi + 1))], 
        [0, 6*self.E*self.J/(self.l**2*(self.Phi + 1)), self.E*self.J*(2 - self.Phi)/(self.l*(self.Phi + 1)), 0, -6*self.E*self.J/(self.l**2*(self.Phi + 1)), self.E*self.J*(self.Phi + 4)/(self.l*(self.Phi + 1))]
                  ])
    return k
...
def M_lin_loc(self):
    m = np.array([
    [self.A*self.l*self.rho/3, 0, 0, self.A*self.l*self.rho/6, 0, 0], 
    [0, self.rho*(70*self.A*self.l**2*self.Phi**2 + 147*self.A*self.l**2*self.Phi + 78*self.A*self.l**2 + 252*self.J)/(210*self.l*(self.Phi**2 + 2*self.Phi + 1)), self.rho*(35*self.A*self.l**2*self.Phi**2 + 77*self.A*self.l**2*self.Phi + 44*self.A*self.l**2 - 420*self.J*self.Phi + 84*self.J)/(840*(self.Phi**2 + 2*self.Phi + 1)), 0, self.rho*(35*self.A*self.l**2*self.Phi**2 + 63*self.A*self.l**2*self.Phi + 27*self.A*self.l**2 - 252*self.J)/(210*self.l*(self.Phi**2 + 2*self.Phi + 1)), self.rho*(-35*self.A*self.l**2*self.Phi**2 - 63*self.A*self.l**2*self.Phi - 26*self.A*self.l**2 - 420*self.J*self.Phi + 84*self.J)/(840*(self.Phi**2 + 2*self.Phi + 1))], 
    [0, self.rho*(35*self.A*self.l**2*self.Phi**2 + 77*self.A*self.l**2*self.Phi + 44*self.A*self.l**2 - 420*self.J*self.Phi + 84*self.J)/(840*(self.Phi**2 + 2*self.Phi + 1)), self.l*self.rho*(7*self.A*self.l**2*self.Phi**2 + 14*self.A*self.l**2*self.Phi + 8*self.A*self.l**2 + 280*self.J*self.Phi**2 + 140*self.J*self.Phi + 112*self.J)/(840*(self.Phi**2 + 2*self.Phi + 1)), 0, self.rho*(35*self.A*self.l**2*self.Phi**2 + 63*self.A*self.l**2*self.Phi + 26*self.A*self.l**2 + 420*self.J*self.Phi - 84*self.J)/(840*(self.Phi**2 + 2*self.Phi + 1)), self.l*self.rho*(-7*self.A*self.l**2*self.Phi**2 - 14*self.A*self.l**2*self.Phi - 6*self.A*self.l**2 + 140*self.J*self.Phi**2 - 140*self.J*self.Phi - 28*self.J)/(840*(self.Phi**2 + 2*self.Phi + 1))], 
    [self.A*self.l*self.rho/6, 0, 0, self.A*self.l*self.rho/3, 0, 0], 
    [0, self.rho*(35*self.A*self.l**2*self.Phi**2 + 63*self.A*self.l**2*self.Phi + 27*self.A*self.l**2 - 252*self.J)/(210*self.l*(self.Phi**2 + 2*self.Phi + 1)), self.rho*(35*self.A*self.l**2*self.Phi**2 + 63*self.A*self.l**2*self.Phi + 26*self.A*self.l**2 + 420*self.J*self.Phi - 84*self.J)/(840*(self.Phi**2 + 2*self.Phi + 1)), 0, self.rho*(70*self.A*self.l**2*self.Phi**2 + 147*self.A*self.l**2*self.Phi + 78*self.A*self.l**2 + 252*self.J)/(210*self.l*(self.Phi**2 + 2*self.Phi + 1)), self.rho*(-35*self.A*self.l**2*self.Phi**2 - 77*self.A*self.l**2*self.Phi - 44*self.A*self.l**2 + 420*self.J*self.Phi - 84*self.J)/(840*(self.Phi**2 + 2*self.Phi + 1))], 
    [0, self.rho*(-35*self.A*self.l**2*self.Phi**2 - 63*self.A*self.l**2*self.Phi - 26*self.A*self.l**2 - 420*self.J*self.Phi + 84*self.J)/(840*(self.Phi**2 + 2*self.Phi + 1)), self.l*self.rho*(-7*self.A*self.l**2*self.Phi**2 - 14*self.A*self.l**2*self.Phi - 6*self.A*self.l**2 + 140*self.J*self.Phi**2 - 140*self.J*self.Phi - 28*self.J)/(840*(self.Phi**2 + 2*self.Phi + 1)), 0, self.rho*(-35*self.A*self.l**2*self.Phi**2 - 77*self.A*self.l**2*self.Phi - 44*self.A*self.l**2 + 420*self.J*self.Phi - 84*self.J)/(840*(self.Phi**2 + 2*self.Phi + 1)), self.l*self.rho*(7*self.A*self.l**2*self.Phi**2 + 14*self.A*self.l**2*self.Phi + 8*self.A*self.l**2 + 280*self.J*self.Phi**2 + 140*self.J*self.Phi + 112*self.J)/(840*(self.Phi**2 + 2*self.Phi + 1))]
    ])
    return m
